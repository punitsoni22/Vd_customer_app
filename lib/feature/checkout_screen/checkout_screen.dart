...
import 'package:vd_customer_app/feature/checkout_screen/widgets/address_container.dart';
import 'package:vd_customer_app/feature/checkout_screen/widgets/delivery_time_cards.dart';
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Summary(label: "Subtotal", value: "\$750"),
                    Summary(label: "Discount", value: "-\$50.00"),
                    Summary(
                      label: "Delivery Charge",
                      value: "Free",
                      color: const Color.fromARGB(255, 237, 98, 98),
                    ),
                    Summary(label: "Estimated Tax", value: "-\$45"),
                    Divider(),
                    Summary(
                      label: "Total  Amount",
                      value: "\$755.00",
